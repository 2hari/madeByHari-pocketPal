...
import { shortcuts, colors } from "@/utils/constants"

import Logo from "../Logo"

export const ExpensesIcon = (active: boolean) => (
  <svg
...
export const IncomeIcon = (active: boolean) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="20"
    width="20"
...
export const SubscriptionsIcon = (active: boolean) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="20"
    width="20"
...
export const SettingsIcon = (active: boolean) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="20"
    width="20"
...
export const SupportIcon = (active: boolean) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="20"
    width="20"
...
export const InvestmentIcon = (active: boolean) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="20"
    width="20"
...
export const LogoutIcon = (active: boolean) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    height="20"
    width="20"
...
const sidebarShortcutsList = Object.values(sidebar).map((i) => i.shortcut)

const links = [
  {
    link: "/",
    activePath: "/app",
    description: "Overview page for all cashflows.",
    name: "Overview",
  ...
  },
  {
    ...
    description: "Add & Edit your cashflows here.",
    name: "Cashflows",
...
export default function Sidebar({
  ...
  useHotkeys(sidebarShortcutsList, (i, handler) => {
    ...
    >
      ...
      >
        <div>
          ...
          <div className="mt-12">
            {links.map((linkItem) => {
              const active = router.pathname === linkItem.link
                ...
                <span key={linkItem.name} onClick={onHide}>
                  ...
                  >
                    <span className="flex items-center">
                      <Icon
                        sx={{
                          color: active ? colors["accent-1"] : "white",
                          fontSize: 20,
                        }}
                      />
                      <span
                        className={`ml-2 ${show ? "visible" : "hidden"} ${
                          active ? "text-accent-1" : "text-white"
                        }`}
                      >
                        {linkItem.name}
                      </span>
          ...
          <div onClick={onHide}>
            <Link
              ...
              className={`mt-2 flex h-[40px] items-center rounded-lg p-2 text-base tracking-wide text-white hover:bg-zinc-800 ${
                router.pathname === "/settings" ? "bg-zinc-800" : ""
              } ${show ? "" : "justify-center"}`}
            >
              <span className="flex items-center">
